...
将 s 0 中每个元素初始化为 0。在时间步 t，首先将小批量随机梯度 gt 按元素平方后累加到变量 st:
![](https://picgo-img-repo.oss-cn-beijing.aliyuncs.com/img/ac2ee5427561b7d8f777cc0c7f895e6d.png)
其中 O 是按元素相乘。接着，我们将目标函数自变量中每个元素的学习率通过按元素运算重新调整
![](https://picgo-img-repo.oss-cn-beijing.aliyuncs.com/img/a356c694be4b93bd6b93ba7c4f8864a3.png)
